...
namespace Stamina.Items.Accessories {
	...
	class LegSpringItem : ModItem {
		...
		public override void SetStaticDefaults() {
			...
			TmlPlayerHelpers.AddArmorEquipAction( "Stamina:LegSprintEquip", delegate ( Player player, int slot, Item myitem ) {
			...
			TmlPlayerHelpers.AddArmorUnequipAction( "Stamina:LegSprintUnequip", delegate ( Player player, int slot, int item_type ) {
